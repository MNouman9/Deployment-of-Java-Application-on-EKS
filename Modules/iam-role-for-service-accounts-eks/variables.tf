...
variable "attach_backend_s3_policy" {
  description = "Determines whether to attach the Backend S3 IAM policy to the role"
  type        = bool
  default     = false
}
...
variable "attach_backend_pricing_policy" {
  description = "Determines whether to attach the Backend Pricing IAM policy to the role"
  type        = bool
  default     = false
}